Facebook Python SDK
====
<table bgcolor="#FF0000"><tr><td><b>This SDK is deprecated.</b> This SDK does not support the new cookie format we rolled out as part of the OAuth migration.  We have no plans to add this support at this time.
</tr></td></table>
